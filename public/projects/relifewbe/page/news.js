...
const newsData = [
    {
        ...
        author: {
            name: "관리자",
            role: "시스템 관리자",
            img: "../img/hanami-baegyeong-illeoseuteuleisyeon.jpg" // 로고 이미지 사용
        },
        image: "../img/Jason_Duval_04.jpg"
    },
    {
        id: 2,
...
// 뉴스 렌더링 함수
function renderNews(news = newsData) {
    newsList.innerHTML = '';
...
function filterNews() {
    ...
    if (filterValue !== 'all') {
        filteredNews = newsData.filter(item => item.tag === filterValue);
    }
